...
class OnlineTrainContCurveDetector(ContCurveDetector):
    ...
    def check(self, value, timestamp):
        ...
        # TODO: self.last_training_time, self.model, self.training_performance, self.training_max = self.batch_train(self.data_list, self.first_data_time, self.last_training_time, self.model, use_cuda, self.training_performance, self.training_max)
